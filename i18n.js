const translations = {
  ...
  fr: {
    ...
    "feat-sources-desc": "Récupère sur YÖKTez, OpenAlex, Semantic Scholar, CORE et Crossref en une seule expérience unifiée. Changez de source via les Paramètres.",
    ...
    "panel-sources-desc": "Basculez entre OpenAlex, Semantic Scholar, CORE, ou Crossref via les Paramètres. Chaque fournisseur met en évidence différentes recherches.",
    ...
    "panel-sources-l1": "5 fournisseurs de bases académiques en accès direct",
    ...
    "sec-sources-desc": "Au lieu d'explorer une base unitaire, TezTok intègre six APIs en open-access — développant la recherche multi-disciplines.",
    "src-yok-title": "YÖKTez",
